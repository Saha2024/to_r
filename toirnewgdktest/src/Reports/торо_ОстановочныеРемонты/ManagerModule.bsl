...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиОтчета.ФункциональныеОпции.Добавить("торо_ИспользоватьОстановочныеРемонты");
	...
	ОписаниеВарианта.Наименование = НСтр("ru = 'Остановочные ремонты'");
	ОписаниеВарианта.Описание = НСтр("ru = 'Основные данные и процент завершения остановочных ремонтов.'");
КонецПроцедуры
