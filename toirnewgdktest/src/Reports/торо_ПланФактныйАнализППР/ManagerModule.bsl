...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	ОписаниеВарианта.Наименование = НСтр("ru = 'План-фактный анализ ППР'");
	ОписаниеВарианта.Описание = НСтр("ru = 'План-фактный анализ работ, запланированных в план-графиках ППР за указанный период, в графическом виде.'");
