...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	ОписаниеВарианта.Наименование = НСтр("ru = 'Минимальные остатки номенклатуры'");
	ОписаниеВарианта.Описание = НСтр("ru = 'Сравнение установленных минимальных остатков номенклатуры с фактическим остатком на складах.'");
