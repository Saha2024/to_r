...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	ОписаниеВарианта.Наименование = НСтр("ru = 'Состояние обеспечения заказов'");
	ОписаниеВарианта.Описание = НСтр("ru = 'Состояние обеспечения заказов на внутреннее потребление.'");
