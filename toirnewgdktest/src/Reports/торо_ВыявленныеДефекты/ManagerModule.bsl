...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиОтчета.Размещение.Вставить(Метаданные.Подсистемы.торо_ПоказателиЭксплуатации.Подсистемы.торо_Дефекты, "Важный");
	...
	ОписаниеВарианта.Наименование = НСтр("ru = 'Выявленные дефекты'");
	ОписаниеВарианта.Описание = НСтр("ru = 'Детальная информация о выявленных за период дефектах.'");
