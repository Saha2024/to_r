...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиОтчета.ФункциональныеОпции.Добавить("торо_ИспользоватьППРИОтменуРемонтов");
	...
	ОписаниеВарианта.Наименование = НСтр("ru = 'Причины отмены плановых ремонтов'");
	ОписаниеВарианта.Описание = НСтр("ru = 'Даты и причины отмены или переноса запланированных ремонтов.'");
