...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	ОписаниеВарианта.Наименование = НСтр("ru = 'Ведомость по товарам на руках'");
	ОписаниеВарианта.Описание = НСтр("ru = 'Количественное движение товаров, выданных под заказы на внутреннее потребление.'");
