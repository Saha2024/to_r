...
Процедура СформироватьНаСервере()
	...
	торо_ПоказателиKPI.СформироватьУниверсальныйОтчетРасшифровкуПоказателя(Результат, Макет, СКД, ТабДанных, Настройки, ВариантАнализа, ПредставлениеПараметров, Разделитель);
