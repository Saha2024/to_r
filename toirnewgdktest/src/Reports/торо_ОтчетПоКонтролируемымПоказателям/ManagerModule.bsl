...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиОтчета.Размещение.Вставить(Метаданные.Подсистемы.торо_ПоказателиЭксплуатации.Подсистемы.торо_СостояниеНаработкаПоказатели.Подсистемы.торо_КонтролируемыеПоказателиОборудования, "Важный");
	НастройкиОтчета.ФункциональныеОпции.Добавить("торо_УчетКонтролируемыхПоказателей");
	...
	ОписаниеВарианта.Наименование = НСтр("ru = 'Контролируемые показатели'");
	ОписаниеВарианта.Описание = НСтр("ru = 'Изменение значений контролируемых показателей оборудования за период.'");
