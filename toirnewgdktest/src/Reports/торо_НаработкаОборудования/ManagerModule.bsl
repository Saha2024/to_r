...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиОтчета.Размещение.Вставить(Метаданные.Подсистемы.торо_ПоказателиЭксплуатации.Подсистемы.торо_СостояниеНаработкаПоказатели.Подсистемы.торо_НаработкаОборудования, "Важный");
	...
	ОписаниеВарианта.Наименование = НСтр("ru = 'Наработка оборудования'");
	ОписаниеВарианта.Описание = НСтр("ru = 'Изменение значений наработки оборудования за период.'");
