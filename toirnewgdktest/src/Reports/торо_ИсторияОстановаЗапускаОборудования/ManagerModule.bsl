...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	ОписаниеВарианта.Наименование = НСтр("ru = 'Останов / запуск оборудования'");
	ОписаниеВарианта.Описание = НСтр("ru = 'Даты остановов и запусков, а также причины остановов оборудования за период.'");
