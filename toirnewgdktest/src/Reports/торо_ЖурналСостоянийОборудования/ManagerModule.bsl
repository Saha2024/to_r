...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	ОписаниеВарианта.Наименование = НСтр("ru = 'Журнал состояний оборудования'");
	ОписаниеВарианта.Описание = НСтр("ru = 'Отчет по периодам и времени нахождения оборудования в различных состояниях (простой, эксплуатация, испытание).'");
