...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	ОписаниеВарианта.Наименование = НСтр("ru = 'Состояние оборудования (показатели, наработка)'");
	ОписаниеВарианта.Описание = НСтр("ru = 'Графическое отображение изменения значений контролируемых показателей и наработки оборудования за период.'");
