...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиОтчета.Размещение.Вставить(Метаданные.Подсистемы.торо_ПоказателиЭксплуатации.Подсистемы.торо_СостояниеНаработкаПоказатели.Подсистемы.торо_СостояниеОборудования, "Важный");
	...
	ОписаниеВарианта.Наименование = НСтр("ru = 'Простой оборудования'");
	ОписаниеВарианта.Описание = НСтр("ru = 'Время простоя оборудования за период.'");
