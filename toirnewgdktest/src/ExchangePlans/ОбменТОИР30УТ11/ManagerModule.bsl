...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	...
	ОписаниеВарианта.ЗаголовокПомощникаСозданияОбмена = НСтр("ru='Настройка синхронизации с 1С:УТ, ред. 11.5 и с 1С:КА, ред. 2.5'");
	ОписаниеВарианта.ЗаголовокУзлаПланаОбмена = НСтр("ru='Синхронизация с 1С:УТ, ред. 11.5 / 1С:КА, ред. 2.5'");
	...
	Если торо_СЛКВнешнееСоединение.СерияЗащитыИнициализирована("28DD") Тогда
		ОписаниеВарианта.КраткаяИнформацияПоОбмену = НСтр("ru = 'Данная настройка позволит синхронизировать данные между программами 1С:ТОИР Управление ремонтами и обслуживанием оборудования КОРП, редакция 3.0 и 1С:Управление торговлей, редакция 11.5 / 1С:Комплексная автоматизация, редакция 2.5.'");
	Иначе
		ОписаниеВарианта.КраткаяИнформацияПоОбмену = НСтр("ru = 'Данная настройка позволит синхронизировать данные между программами 1С:ТОИР Управление ремонтами и обслуживанием оборудования ПРОФ, редакция 3.0 и 1С:Управление торговлей, редакция 11.5 / 1С:Комплексная автоматизация, редакция 2.5.'");
	КонецЕсли;
	
	ОписаниеВарианта.ПодробнаяИнформацияПоОбмену = "ПланОбмена.ОбменТОИР30УТ11.Форма.ПодробнаяИнформация";
	ОписаниеВарианта.ПояснениеДляНастройкиПараметровУчета =  НСтр("ru = '??????'");
	
	ОписаниеВарианта.ОбщиеДанныеУзлов = "";
	ОписаниеВарианта.ИмяКонфигурацииКорреспондента = "1С:УТ, ред. 11.5 / 1С:КА, ред. 2.5";
	ОписаниеВарианта.НаименованиеКонфигурацииКорреспондента = "1С:УТ, ред. 11.5 / 1С:КА, ред. 2.5";
