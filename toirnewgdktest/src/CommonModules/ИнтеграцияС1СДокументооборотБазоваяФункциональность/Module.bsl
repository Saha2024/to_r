...
Процедура ВыполнитьОбменДанными() Экспорт
	...
	// ТОИР++
	Если НЕ торо_СЛКВнешнееСоединение.СерияЗащитыИнициализирована("28DD") Тогда
		Настройки.ИспользоватьИнтеграциюДО2 = Ложь;
		Настройки.ИспользоватьИнтеграциюДО3 = Ложь;
	КонецЕсли;
	// ТОИР--
