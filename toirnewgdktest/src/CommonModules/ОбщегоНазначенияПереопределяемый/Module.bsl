...
Процедура ПриОпределенииОбщихПараметровБазовойФункциональности(ОбщиеПараметры) Экспорт
	...
	ОбщиеПараметры.ИмяФормыПерсональныхНастроек = "ОбщаяФорма.торо_ПользовательскиеНастройки";
	ОбщиеПараметры.МинимальнаяВерсияПлатформы = "8.3.17.2760";
	ОбщиеПараметры.РекомендуемаяВерсияПлатформы = "8.3.17.2760";
...
Процедура ПриДобавленииПереименованийОбъектовМетаданных(Итог) Экспорт
	...
	// ТОИР++
	ОбщегоНазначения.ДобавитьПереименование(Итог, "2.0.30.1",
        "Роль.торо_ДобавлениеИзменениеПометкаУдаленияЗначенийИзмеряемыхПоказателейОбъектовРемонта",
        "Роль.торо_ДобавлениеИзменениеЗначенийИзмеряемыхПоказателейОбъектовРемонта");
	ОбщегоНазначения.ДобавитьПереименование(Итог, "2.0.30.1",
        "Роль.торо_ДобавлениеИзменениеПометкаУдаленияЗначенийКоэффициентовРемонтныхОсобенностей",
        "Роль.торо_ДобавлениеИзменениеЗначенийКоэффициентовРемонтныхОсобенностей");
	ОбщегоНазначения.ДобавитьПереименование(Итог, "2.0.30.1",
        "Роль.торо_ДобавлениеИзменениеПроведениеПометкаУдаленияИзмененийСоставаРемонтнойБригады",
        "Роль.торо_ДобавлениеИзменениеПроведениеИзмененийСоставаРемонтнойБригады");
	ОбщегоНазначения.ДобавитьПереименование(Итог, "2.0.30.1",
        "Роль.торо_ДобавлениеИзменениеПроведениеПометкаУдаленияКоэффициентовРемонтныхОсобенностей",
        "Роль.торо_ДобавлениеИзменениеПроведениеКоэффициентовРемонтныхОсобенностей");
	ОбщегоНазначения.ДобавитьПереименование(Итог, "2.0.30.1",
        "Роль.торо_ДобавлениеИзменениеПроведениеПометкаУдаленияНастройкиРегистрацииНаработкиЗависимыхОР",
        "Роль.торо_ДобавлениеИзменениеПроведениеНастройкиРегистрацииНаработкиЗависимыхОР");
	ОбщегоНазначения.ДобавитьПереименование(Итог, "2.0.30.1",
        "Роль.торо_ДобавлениеИзменениеПроведениеПометкаУдаленияПрисвоенийКвалификацийСотрудникам",
        "Роль.торо_ДобавлениеИзменениеПроведениеПрисвоенийКвалификацийСотрудникам");
	ОбщегоНазначения.ДобавитьПереименование(Итог, "2.0.30.1",
        "Роль.торо_ДобавлениеИзменениеПроведениеПометкаУдаленияУстановкаАналоговНоменклатурыДляРемонтов",
        "Роль.торо_ДобавлениеИзменениеПроведениеУстановкаАналоговНоменклатурыДляРемонтов");
	ОбщегоНазначения.ДобавитьПереименование(Итог, "2.0.30.1",
        "Роль.торо_ДобавлениеИзменениеПроведениеПометкаУдаленияУстановкаЦелевыхЗначенийПоказателейKPI",
        "Роль.торо_ДобавлениеИзменениеПроведениеУстановкаЦелевыхЗначенийПоказателейKPI");
	ОбщегоНазначения.ДобавитьПереименование(Итог, "2.0.30.1",
        "Роль.торо_ДобавлениеИзменениеПроведениеПометкаУдаленияУстановокКоэффициентовПереводаСтоимостейРемонтов",
        "Роль.торо_ДобавлениеИзменениеПроведениеУстановокКоэффициентовПереводаСтоимостей");
	ОбщегоНазначения.ДобавитьПереименование(Итог, "2.0.30.1",
        "Роль.торо_ДобавлениеИзменениеПроведениеПометкаУдаленияУстановокЛимитовНаПлановыеРемонтныеРаботы",
        "Роль.торо_ДобавлениеИзменениеПроведениеУстановокЛимитовНаПлановыеРемонтныеРаботы");
	ОбщегоНазначения.ДобавитьПереименование(Итог, "2.0.30.1",
        "Роль.торо_ДобавлениеИзменениеПроведениеПометкаУдаленияУстановокМинимальныхОстатковНоменклатуры",
        "Роль.торо_ДобавлениеИзменениеПроведениеУстановокМинимальныхОстатковНоменклатуры");
	ОбщегоНазначения.ДобавитьПереименование(Итог, "2.0.30.1",
        "Роль.торо_ДобавлениеИзменениеПроведениеПометкаУдаленияУстановокПроизвольныхЗначенийНаработки",
        "Роль.торо_ДобавлениеИзменениеПроведениеУстановокПроизвольныхЗначенийНаработки");
	ОбщегоНазначения.ДобавитьПереименование(Итог, "2.0.30.1",
        "Роль.торо_ДобавлениеИзменениеПометкаУдаленияСтатусовСогласованияДокументовРемонтныхРабот",
        "Роль.торо_ДобавлениеИзменениеСтатусовСогласованияДокументовРемонтныхРабот");
	ОбщегоНазначения.ДобавитьПереименование(Итог, "2.0.30.1",
        "Роль.торо_ДобавлениеИзменениеПометкаУдаленияТиповКоэффициентовПереводаСтоимостейРемонтов",
        "Роль.торо_ДобавлениеИзменениеТиповКоэффициентовПереводаСтоимостейРемонтов");
	ОбщегоНазначения.ДобавитьПереименование(Итог, "2.0.30.1",
        "Роль.торо_ОтчетПланВнепленРемонты",
        "Роль.торо_ОтчетПлановыеВнеплановыеРемонты");
	ОбщегоНазначения.ДобавитьПереименование(Итог, "2.0.30.1",
        "Роль.ИспользованииеОценкиПроизводительности",
        "Роль.ИспользованиеОценкиПроизводительности");
	ОбщегоНазначения.ДобавитьПереименование(Итог, "2.0.30.1",
        "Роль.торо_ДобавлениеИзменениеПроведениеПометкаУдаленияИзмененийПоложенияВСтруктуреИерархии",
        "Роль.торо_ДобавлениеИзменениеПроведениеИзмененийПоложенияВСтруктуреИерархии");	
	// ТОИР --
КонецПроцедуры
...
Процедура ПриДобавленииСерверныхОповещений(Оповещения) Экспорт
	...
	торо_РаботаСУведомлениями.ПриДобавленииСерверныхОповещений(Оповещения);
