...
Процедура ПроверитьНаличиеНовыхЭлектронныхДокументовВСервисе1СЭДО() Экспорт
	...
	ИмяПараметра = ОповещенияОСобытияхЭДОКлиентСервер.ПараметрПриложения_ЕстьНовыеДокументы();
...
#КонецЕсли
	...
	Если ПараметрыРаботы.Свойство(ПараметрРаботыКлиента_ЕстьНовыеДокументыЭДО) Тогда
		ПараметрПриложения_ЕстьНовыеДокументы = ОповещенияОСобытияхЭДОКлиентСервер.ПараметрПриложения_ЕстьНовыеДокументы();
...
// СтандартныеПодсистемы.БазаваяФункциональность
...
// Конец СтандартныеПодсистемы.БазаваяФункциональность
