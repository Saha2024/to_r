...
//  Строка
//
Функция ТекстЗапросаПоОсновойТаблице(ОсновнаяТаблица) Экспорт
...
Процедура ДобавитьСлужебноеПолеВДинамическийСписок(ДинамическийСписок, ИмяПоля) Экспорт
	...
	КонецЕсли;
	// При измененении свойства ТекстЗапроса платформа сбрасывает значение ОсновнаяТаблица,
...
// Определяет, находится ли объект данных в режиме обмена данными.
// 
// Параметры:
// 	Источник - Объект - объект ссылочного типа.
// Возвращаемое значение:
// 	Булево - Истина, если объект в режиме обмена данными.
Функция ОбъектВРежимеОбменаДанными(Источник) Экспорт
	
	Возврат Источник.ОбменДанными.Загрузка;
...
//                                         формируется функцией ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОбработкиОшибки.
