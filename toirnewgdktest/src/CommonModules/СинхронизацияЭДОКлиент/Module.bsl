...
Процедура ПослеПолученияПараметровСинхронизации(Результат, Контекст) Экспорт
	...
	ПараметрыСинхронизации = СинхронизацияЭДОСлужебныйКлиент.РезультатВыполненияФоновогоЗадания(
...
Процедура СформироватьИОтправитьТранспортныеКонтейнерыПослеОтправки(Результат, Контекст) Экспорт
	...
	РезультатОтправки = СинхронизацияЭДОСлужебныйКлиент.РезультатВыполненияФоновогоЗадания(
