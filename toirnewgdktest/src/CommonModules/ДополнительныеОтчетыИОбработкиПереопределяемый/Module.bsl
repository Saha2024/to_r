...
Процедура ОпределитьРазделыСДополнительнымиОбработками(Разделы) Экспорт
	...
	Разделы.Добавить(Метаданные.Подсистемы.торо_ОборудованиеИНормативы);
	...
	Разделы.Добавить(Метаданные.Подсистемы.торо_ПоказателиЭксплуатации);
	Разделы.Добавить(Метаданные.Подсистемы.торо_НарядыИРаботы);
	Разделы.Добавить(Метаданные.Подсистемы.торо_УправлениеПерсоналом);
	Разделы.Добавить(ДополнительныеОтчетыИОбработкиКлиентСервер.ИмяНачальнойСтраницы());
	Разделы.Добавить(Метаданные.Подсистемы.торо_ПоказателиKPI);
