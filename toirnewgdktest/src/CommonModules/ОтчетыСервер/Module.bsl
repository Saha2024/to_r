...
Процедура ДобавитьЭлементыСписка(Форма, ЭлементНастройки, ОписаниеЭлементаНастройки, ИмяСписка, ИменаРеквизитов)
	...
	// ТОИР++
	// Очистим старые значения, для корректного перезаполнения настроек
	// при изменении ОР в отчете "Состояние оборудования".
	Если Форма.ИмяФормы = "Отчет.торо_СостояниеОборудования.ФормаНастроек" Тогда
		ПолеЗначения.СписокВыбора.Очистить();
	КонецЕсли;
	// ТОИР--
