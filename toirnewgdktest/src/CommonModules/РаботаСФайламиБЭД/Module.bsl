...
// Возвращаемое значение:
// 	ДвоичныеДанные
Функция XDTOВДвоичныеДанные(ОбъектXDTO, УказаниеТипа = Истина, ТипКодировки = "windows-1251") Экспорт
	...
	ФабрикаXDTO.ЗаписатьXML(ЗаписьXML, ОбъектXDTO,,,,
		?(УказаниеТипа, НазначениеТипаXML.Явное, НазначениеТипаXML.Неявное));
	ЗаписьXML.Закрыть();
