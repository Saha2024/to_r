...
Процедура ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка) Экспорт
	...
	Если Форма.Параметры.Свойство("ПараметрыОтчета") Тогда
		Форма.НастройкиОтчета.Вставить("ПараметрыОтчета", Форма.Параметры.ПараметрыОтчета);
	ИначеЕсли Форма.Параметры.Свойство("ОписаниеКоманды") И ТипЗнч(Форма.Параметры.ОписаниеКоманды) = Тип("Структура") 
		И Форма.Параметры.ОписаниеКоманды.Свойство("ДополнительныеПараметры") 
		И ТипЗнч(Форма.Параметры.ОписаниеКоманды.ДополнительныеПараметры) = Тип("Структура") 
		И Форма.Параметры.ОписаниеКоманды.ДополнительныеПараметры.Свойство("ПараметрыОтчета") Тогда
		Форма.НастройкиОтчета.Вставить("ПараметрыОтчета", Форма.Параметры.ОписаниеКоманды.ДополнительныеПараметры.ПараметрыОтчета);
	КонецЕсли;
...
Процедура ПередЗагрузкойВариантаНаСервере(Форма, НовыеНастройкиКД) Экспорт
	...
	торо_ПоказателиKPI.ОтчетРасшифровка_ПриЗагрузкеВариантаНаСервере(Форма.РеквизитФормыВЗначение("Отчет"), Форма, НовыеНастройкиКД);
	НовыеНастройкиКД.ПараметрыВывода.УстановитьЗначениеПараметра("МакетОформления", БиблиотекаМакетовОформленияКомпоновкиДанных.Античный.Имя);
