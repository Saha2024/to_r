...
Процедура НачатьПодписаниеРегистрационногоПакета1СЭДО(ОбработкаПродолжения, ДанныеПакета, ОтборСертификатов) Экспорт
	...
	КонтекстПодписания.Вставить("ДанныеНаПодпись", ДанныеНаПодпись);
