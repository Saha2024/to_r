...
// Возвращает числовое значение ставки НДС по значению справочника
//
// Параметры:
// 		СтавкаНДС - СправочникСсылка.СтавкиНДС - значение перечисления СтавкиНДС.
//
// Возвращаемое значение:
...
Функция ПолучитьСтавкуНДСЧислом(СтавкаНДС) Экспорт
	Если СтавкаНДС.Пустая() Тогда 
		Возврат 0;
	Иначе
		Возврат торо_ОбщегоНазначенияВызовСервера.ЗначениеРеквизитаОбъекта(СтавкаНДС, "Ставка") / 100; 
	КонецЕсли;
...
// 		Число - Значение ставки НДС числом.
//
Функция ЗначениеСтавкиНДСИзПеречисления(Знач СтавкаНДС) Экспорт
