...
Функция ТипЗначенияОграниченныйСвязьюПоТипу(Настройки, ПользовательскиеНастройки, ЭлементНастройки, ОписаниеЭлементаНастройки, ТипЗначения = Неопределено) Экспорт 
	...
	// ТОИР++
	ИначеЕсли ТипЗнч(ЗначениеСвязанногоЭлементаНастройки) = Тип("СправочникСсылка.торо_СтруктурыОР") Тогда
		ОписаниеСвязанныхТипов = торо_РаботаСИерархией20КлиентСервер.ПолучитьОписаниеТиповЭлементовВИерархии(ЗначениеСвязанногоЭлементаНастройки);
		Возврат ОписаниеСвязанныхТипов;
	// ТОИР--
	Иначе
