...
Процедура УстановитьЭлементОтбора(ОбластьПоискаДобавления,
	...
	Если ЧислоИзмененных = 0 Тогда
		...
		// ТОиР++
		Если ТипЗнч(ОбластьПоискаДобавления) = Тип("ОтборКомпоновкиДанных") 
			И ОбластьПоискаДобавления.ДоступныеПоляОтбора.НайтиПоле(Новый ПолеКомпоновкиДанных(ИмяПоля)) = Неопределено Тогда
			Возврат;
		КонецЕсли;
		// ТОиР--
