...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	СписокОбъектов.Добавить(Документы.торо_АнализКоренныхПричин);
	...
	СписокОбъектов.Добавить(Документы.торо_ЗаказПоставщику);
	...
	СписокОбъектов.Добавить(Документы.торо_Инвентаризация);
	...
	СписокОбъектов.Добавить(Документы.торо_ПлановаяДоступностьПерсонала);
...
Процедура ПередДобавлениемКомандПечати(ИмяФормы, КомандыПечати, СтандартнаяОбработка) Экспорт
	...
	ИнтеграцияС1СДокументооборотБазоваяФункциональностьПереопределяемый.ПередДобавлениемКомандПечати(ИмяФормы, КомандыПечати, СтандартнаяОбработка);
