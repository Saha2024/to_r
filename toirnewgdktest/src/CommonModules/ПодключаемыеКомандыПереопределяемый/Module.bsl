...
Процедура ПриОпределенииВидовПодключаемыхКоманд(ВидыПодключаемыхКоманд) Экспорт
	...
	Для каждого ВидКоманд из ВидыПодключаемыхКоманд Цикл
		Если ВидКоманд.Имя = "Печать" Тогда
			ВидКоманд.ВидГруппыФормы = ВидГруппыФормы.Подменю;
		КонецЕсли;
	КонецЦикла;
...
Процедура ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды) Экспорт
	...
	Для каждого Команда из Команды Цикл
		Если Команда.Обработчик = "ГрупповоеИзменениеОбъектовКлиент.ОбработчикКоманды" Тогда // команда "Изменить выделенные..."
