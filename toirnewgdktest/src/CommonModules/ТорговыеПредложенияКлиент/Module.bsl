...
//    *РежимВыбораТорговогоПредложения - Булево - признак выбора режима торгового предложения
...
Процедура УстановитьПояснениеДлительнойОперации(ЭлементФормы, ТекстПрогресса, ПроцентПрогресса = Неопределено)
	...
	ЧастиСтроки.Добавить(ТекстСостояния);
	ЧастиСтроки.Добавить(". ");
	ЧастиСтроки.Добавить(Новый ФорматированнаяСтрока(НСтр("ru = 'Отменить'"), , , , "ОтменитьФоновоеЗадание"));
	
	ЭлементФормы.Заголовок = Новый ФорматированнаяСтрока(ЧастиСтроки);
...
Процедура ВыполнитьСинхронизациюТорговыхПредложений(ПараметрыСинхронизации, ДлительнаяОперация) Экспорт
	...
	ТорговыеПредложенияВызовСервера.ВыполнитьСинхронизациюТорговыхПредложенийВФоне(ДлительнаяОперация);
...
Процедура ПроверитьСостояниеСинхронизацииТорговыхПредложений(ДлительнаяОперация, ПараметрыСинхронизации)
	ТорговыеПредложенияВызовСервера.НайтиДлительнуюОперациюТорговогоСинхронизацииТорговыхПредложений(ДлительнаяОперация);
