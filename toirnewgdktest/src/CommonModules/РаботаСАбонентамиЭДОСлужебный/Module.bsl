...
Процедура ОбновитьСостоянияКонтрагентов(Контрагенты) Экспорт
	...
	Запрос.Текст =
		...
		|		ПО &ИмяРеквизитаИННКонтрагента = ПриглашенияРеквизитыКонтрагента.ИНН
		|		И &ИмяРеквизитаКППКонтрагента = ПриглашенияРеквизитыКонтрагента.КПП
		|ГДЕ
		...
		|		ПО &ИмяРеквизитаИННКонтрагента = Абоненты.ИНН
		|		И &ИмяРеквизитаКППКонтрагента = Абоненты.КПП
	...
	Запрос.Текст = СтрЗаменить(Запрос.Текст, "&ИмяРеквизитаИННКонтрагента",
		СтрШаблон("%1.%2", ИмяПрикладногоСправочника, ИмяРеквизитаИННКонтрагента));

	ИмяРеквизитаКППКонтрагента = ИнтеграцияЭДО.ИмяНаличиеОбъектаРеквизитаВПрикладномРешении("КППКонтрагента");
	Запрос.Текст = СтрЗаменить(Запрос.Текст, "&ИмяРеквизитаКППКонтрагента",
		СтрШаблон("%1.%2", ИмяПрикладногоСправочника, ИмяРеквизитаКППКонтрагента));
	...
	КодыИСостоянияПодключения = РаботаСАбонентамиЭДОСлужебный.КодыИСостоянияКонтрагентов(Истина);
