...
Процедура ПередНачаломРаботыСистемы(Параметры) Экспорт
	...
	торо_ОбщегоНазначенияКлиент.ПередНачаломРаботыСистемы(Параметры);
...
Процедура ПослеНачалаРаботыСистемы() Экспорт
	...
	ИнтеграцияС1СДокументооборотБазоваяФункциональностьКлиент.ПослеНачалаРаботыСистемы();
...
Процедура ПриУстановкеЗаголовкаКлиентскогоПриложения(ЗаголовокПриложения, ПриЗапуске) Экспорт
	Если торо_СЛКСервер.СерияЗащитыИнициализирована("28DD", Истина) Тогда
		ПодзаголовокТОИР = НСтр("ru = '1С:ТОИР Управление ремонтами и обслуживанием оборудования КОРП, редакция 3.0'"); 
	ИначеЕсли торо_СЛКСервер.СерияЗащитыИнициализирована("5DD5", Истина) Тогда
		ПодзаголовокТОИР = НСтр("ru = '1С:ТОИР Управление ремонтами и обслуживанием оборудования ПРОФ, редакция 3.0'");
	Иначе
		ПодзаголовокТОИР = НСтр("ru = '1С:ТОИР Управление ремонтами и обслуживанием оборудования, редакция 3.0'");
	КонецЕсли;
	
	ПозицияНачалаЗаголовкаТОИР = СтрНайти(ЗаголовокПриложения, "1С:ТОИР");
	Если ПозицияНачалаЗаголовкаТОИР <> 1 Тогда 
		ЛеваяЧастьЗаголовка = Лев(ЗаголовокПриложения, ПозицияНачалаЗаголовкаТОИР - 1);
		ЗаголовокПриложения = СтрШаблон("%1%2", ЛеваяЧастьЗаголовка, ПодзаголовокТОИР);
	Иначе
		ЗаголовокПриложения = ПодзаголовокТОИР;
	КонецЕсли;
КонецПроцедуры
