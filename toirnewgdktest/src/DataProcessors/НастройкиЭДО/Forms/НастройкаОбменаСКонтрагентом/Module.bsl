...
Процедура ЗавершитьРаботуМастера(Результат)
	...
	Если ПредварительнаяНастройка Тогда
		...
		Иначе 
			НастройкаОтправки = СохраненнаяНастройкаОтправки(КлючНастроекОтправки);
			НастройкаОтправки.Договор = 
				?(ЗначениеЗаполнено(НастройкаОтправки.Договор), НастройкаОтправки.Договор, КлючНастроекОтправки.Договор);
		КонецЕсли;
	Иначе
