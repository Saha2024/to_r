...
Функция ЗапуститьВыгрузкуНоменклатурыВФоне(Знач РазделениеВключено, Знач Организация, Знач ПроверитьГотовность = Ложь)
	...
	ЗначениеНовая = СписокСостояний.Добавить(Перечисления.СостоянияВыгрузкиНоменклатуры.Новая);
	...
	СписокСостояний.Удалить(ЗначениеНовая);
...
Функция ПрогрессВыгрузки(Знач ПараметрыПрогресса)
	...
	//@skip-warning
	Перем Организация, ИдентификаторЗадания, РазделениеВключено, СоздатьЗадание, ИдентификаторФормы, ЛимитЗаписей; 
	
	ПараметрыПрогресса.Свойство("Организация", Организация);
	ПараметрыПрогресса.Свойство("ИдентификаторЗадания", ИдентификаторЗадания);
	ПараметрыПрогресса.Свойство("РазделениеВключено", РазделениеВключено);
	ПараметрыПрогресса.Свойство("СоздатьЗадание", СоздатьЗадание);
	ПараметрыПрогресса.Свойство("УникальныйИдентификатор", ИдентификаторФормы);
	ПараметрыПрогресса.Свойство("ЛимитЗаписей", ЛимитЗаписей);
