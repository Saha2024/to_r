...
Процедура ОтправитьЗаказы(Знач ПараметрыПроцедуры, Знач АдресРезультата) Экспорт
	...
	Для Каждого СтрокаТаблицыЗаказов Из СписокЗаказов Цикл
		...
		ПараметрыКоманды.Вставить("ДвоичныеДанныеПредставления", ПолучитьИзВременногоХранилища(СтрокаТаблицыЗаказов.АдресХранилищаПредставления));
...
Процедура ОбновитьСтатистикуСостояний(Знач ПараметрыПроцедуры, Знач АдресРезультата) Экспорт 
	...
	Замер = ОценкаПроизводительности.НачатьЗамерДлительнойОперации(
		"Обработка.ТорговыеПредложения.Форма.СостояниеПубликацииТоваров.ОбновитьСтатистикуСостояний");
...
Процедура ПолучитьДанныеДиагностики(Знач ПараметрыПроцедуры, Знач АдресРезультата) Экспорт
	...
	Замер = ОценкаПроизводительности.НачатьЗамерДлительнойОперации(
		"Обработка.ТорговыеПредложения.Форма.ОшибкиПубликации.ПолучитьДанныеДиагностики");
	
	ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(ПараметрыПроцедуры, "Отбор", Отбор);
	...
	Если ЗначениеЗаполнено(Отбор) Тогда
		...
		Если ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(Отбор, "ПрайсЛист", ПрайсЛист) Тогда
		...
		Если ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(
			Отбор, "ПозицииТорговыхПредложений", ПозицииТорговыхПредложений) Тогда
