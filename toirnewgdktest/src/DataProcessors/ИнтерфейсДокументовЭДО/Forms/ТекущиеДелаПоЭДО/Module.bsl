...
Процедура ДополнитьДокументамиПакетов(ЭлектронныеДокументы)
	...
	ИнтерфейсДокументовЭДО.ДополнитьДокументамиПакетов(ЭлектронныеДокументы);
...
Функция ОбъектыДействий(СтрокиРаздела)
	...
	Результат = Новый Структура("ЭлектронныеДокументы, ПакетыДокументов", Новый Массив, Новый Массив);
...
Процедура ЗаполнитьДанныеОбластиПросмотраПоФайлу(СтруктураВозврата, ПараметрыФормирования)
	...
	ЗначенияПараметров.Вставить("Дата", Формат(ПараметрыДокумента.ДатаДокумента, НСтр("ru='ДФ=dd.MM.yyyy;'")));
