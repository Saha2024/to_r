...
Процедура ОчиститьПравилоЗаполненияПриЗагрузке(Правило)
	...
	// ТОИР++ 
	// Исправлена ошибка, при которой очищалась ссылка на дополнительный реквизит при заполнении правил по умолчанию.
	// Впоследствии из-за этого в табличных частях ДополнительныеРеквизиты не заполнялось Свойство.
