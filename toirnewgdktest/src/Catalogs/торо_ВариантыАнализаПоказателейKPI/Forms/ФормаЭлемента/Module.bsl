...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Объект.Владелец, "РазделительКакЕдиницаИзмерения") = Неопределено Тогда
		Элементы.ЕдиницаИзмерения.ПодсказкаВвода = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Объект.Владелец, "Разделитель");
	Иначе
		Элементы.ЕдиницаИзмерения.ПодсказкаВвода = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Объект.Владелец, "ЕдиницаИзмерения");
	КонецЕсли;
...
Функция ПолучитьРазрешенныеАгрегации()
	...
	СтруктураПоиска.Вставить("ТипПоказателя", торо_ОбщегоНазначенияВызовСервера.ЗначениеРеквизитаОбъекта(Объект.Владелец, "ТипПоказателя"));
...
&НаКлиенте
Процедура ОбновитьОтображениеФлагов()

	Элементы.ОтображатьЛегенду.Видимость = (Объект.ВариантОтображенияПоУмолчанию = ПредопределенноеЗначение("Перечисление.торо_ВариантыОтображенияВариантовАнализа.Диаграмма")
		И НЕ Объект.ТипДиаграммы = ПредопределенноеЗначение("Перечисление.торо_ТипыДиаграммПоказателей.Измерительная")
		И НЕ Объект.ТипАнализа = ПредопределенноеЗначение("Перечисление.торо_ТипыАнализа.ДинамикаИзменения")
		И НЕ Объект.ТипДиаграммы.Пустая());
	Элементы.ОтображатьПодписи.Видимость = (Объект.ВариантОтображенияПоУмолчанию = ПредопределенноеЗначение("Перечисление.торо_ВариантыОтображенияВариантовАнализа.Диаграмма")
		И НЕ Объект.ТипДиаграммы = ПредопределенноеЗначение("Перечисление.торо_ТипыДиаграммПоказателей.Измерительная")
		И НЕ Объект.ТипДиаграммы.Пустая());
