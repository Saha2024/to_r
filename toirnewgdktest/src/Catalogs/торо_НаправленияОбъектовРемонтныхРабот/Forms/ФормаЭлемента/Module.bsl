...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ ЗначениеЗаполнено(Объект.Ссылка) И Объект.Состав.Количество() > 0 Тогда
		ЗаполнитьДопРеквизитыПоСпискуНаправлений();	
	КонецЕсли;
...
Процедура ЗаполнитьДополнительныеРеквизиты(НаборСвойств, ТипВладельцаНабораЭлементов)
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |ГДЕ
	               |	НаборыДополнительныхРеквизитовИСведенийДополнительныеРеквизиты.Ссылка = &ОсновнойНабор
	               |
	               |ОБЪЕДИНИТЬ ВСЕ
	               |
	               |ВЫБРАТЬ
	...
	Запрос.УстановитьПараметр("ОсновнойНабор", УправлениеСвойствами.НаборСвойствПоИмени("Справочник_торо_НаправленияОбъектовРемонтныхРабот_Общие")); 
...
&НаСервере
Процедура ЗаполнитьДопРеквизитыПоСпискуНаправлений()
	...
	СтруктураДопРеквизитов = ПолучитьСтруктуруДопРеквизитов(СписокНаправлений);
