...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// ТОИР++
	Элементы.Отборы.УстановитьДействие("ПриНачалеРедактирования", "Подключаемый_ОтборыПриНачалеРедактирования");
	// ТОИР--
...
&НаКлиенте
Процедура Подключаемый_ОтборыПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	...
	Если Строка(Строка.ЛевоеЗначение) = "ОбъектИерархии" Тогда
		УстановитьПараметрыРедактирования(Строка);
	КонецЕсли;
	// ТОИР--
...
Процедура ОтборыПослеВыбораПоля(ОписаниеНастройки, ИдентификаторСтроки) Экспорт
	...
	Если ЗначениеЗаполнено(ОписаниеНастройки.СвязьПоТипу) Тогда
		ТекущиеНастройки = ЭлементСтруктурыНастроек(Отчет.КомпоновщикНастроек.Настройки, ИдентификаторЭлементаСтруктурыНастроек);
		ПользовательскиеНастройки = Отчет.КомпоновщикНастроек.ПользовательскиеНастройки.Элементы;
		ОписаниеТипа = ОтчетыКлиент.ТипЗначенияОграниченныйСвязьюПоТипу(
			ТекущиеНастройки, ПользовательскиеНастройки, ЭлементНастройки, ОписаниеНастройки);
		ЭлементНастройки.ПравоеЗначение = ОписаниеТипа.ПривестиЗначение();	
	Иначе
		ЭлементНастройки.ПравоеЗначение = ОписаниеНастройки.Тип.ПривестиЗначение();
	КонецЕсли;
	// ТОИР--
...
Процедура УстановитьПараметрыРедактирования(Строка)
	...
	// ТОИР++
	ПолеЗначения.ОграничениеТипа = Строка.ТипЗначения;
	// ТОИР--
