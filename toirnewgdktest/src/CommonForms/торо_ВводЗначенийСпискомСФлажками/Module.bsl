...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОтборВладелец = ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(Параметры, "ОтборВладелец");
	
	Если ТипЗнч(ОтборВладелец) = Тип("СписокЗначений") Тогда
		МассивПодразделений = ОтборВладелец;
		Элементы.СписокПодбор.Видимость = Ложь;
		Элементы.ФормаПодбор.Видимость = Истина;
		
		Элементы.СписокПодборПодвал.Видимость = Ложь;
		Элементы.ФормаПодборПодвал.Видимость = Истина;
	
	КонецЕсли;
	
	ОтображатьПометки = ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(Параметры, "ОтображатьПометки");
	
	Если ОтображатьПометки = Ложь Тогда
		Элементы.СписокВставитьИзБуфераОбмена.Видимость				= Ложь;
		Элементы.СписокУстановитьФлажки.Видимость					= Ложь;
		Элементы.СписокСнятьФлажки.Видимость						= Ложь;
		Элементы.СписокВставитьИзБуфераОбменаМеню.Видимость			= Ложь;
		Элементы.СписокУстановитьФлажкиМеню.Видимость				= Ложь;
		Элементы.СписокСнятьФлажкиМеню.Видимость					= Ложь;
...
Процедура Подбор(Команда)
	СтруктураОтбора = Новый Структура("Подразделение", МассивПодразделений.ВыгрузитьЗначения());
	...
	ОткрытьФорму("Справочник.торо_РемонтныеБригады.ФормаВыбора", СтруктураПараметров, Элементы.Список);
КонецПроцедуры
