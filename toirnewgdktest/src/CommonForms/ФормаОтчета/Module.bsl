...
Процедура ПриЗагрузкеПользовательскихНастроекНаСервере(НовыеПользовательскиеНастройкиКД)
	...
	// ТОиР++
	торо_ПоказателиKPI.ОтчетРасшифровка_ПриЗагрузкеПользовательскихНастроекНаСервере(РеквизитФормыВЗначение("Отчет"), ЭтаФорма, НовыеПользовательскиеНастройкиКД);
	// ТОиР--
